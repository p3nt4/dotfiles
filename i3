...
# Workspace definiton
#rename workspace 1 to "ter"
#rename workspace 2 to "www"
...
bindsym $mod+Shift+9 move container to workspace 9:d
...
#exec xautolock -time 5 -locker "i3lock -i '~/Pictures/wallpaper.png'" &
...
bindsym $mod+shift+l exec "killall xautolock || xautolock -time 5 -locker '~/.scripts/lock.sh' &"
